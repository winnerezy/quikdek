...
export const Sidebar = () => {
  ...
  return (
    <aside
      className={cn(
        "w-[250px] flex h-full max-lg:absolute top-0 lg:top-16 left-0 z-50 bg-background flex-col items-center gap-6 cursor-pointer duration-300 ease-in-out lg:fixed ",
    ...
    >
      ...
      <Link
        href={"/home"}
        className="relative flex gap-2 mt-20 w-48 h-10 rounded-lg hover:bg-[--hover] items-center text-md"
      >
